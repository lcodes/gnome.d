...
//struct _GProxyResolverInterface GProxyResolverInterface;

struct GProxyResolverInterface {
  GTypeInterface g_iface;

  /* Virtual Table */
  gboolean function(GProxyResolver       *resolver) is_supported;

  gchar	** function(GProxyResolver       *resolver,
			      const(gchar)*          uri,
			      GCancellable         *cancellable,
			      GError              **error) lookup;

  void     function(GProxyResolver       *resolver,
			      const(gchar)*          uri,
			      GCancellable         *cancellable,
  ...
  gchar	** function(GProxyResolver       *resolver,
			      GAsyncResult         *result,
			      GError              **error) lookup_finish;
};

GType		g_proxy_resolver_get_type       () pure;
