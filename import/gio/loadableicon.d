 ...
 * as a stream.
 **/
//struct _GLoadableIconIface    		GLoadableIconIface;
...
struct GLoadableIconIface {
  ...
  GInputStream * function(GLoadableIcon       *icon,
                                  int                  size,
                                  char               **type,
                                  GCancellable        *cancellable,
                                  GError             **error) load;
  void           function(GLoadableIcon       *icon,
                                  int                  size,
                                  GCancellable        *cancellable,
  ...
  GInputStream * function(GLoadableIcon       *icon,
                                  GAsyncResult        *res,
                                  char               **type,
                                  GError             **error) load_finish;
};

GType         g_loadable_icon_get_type    () pure;
