 ...
 * Since: 2.28
 */
//struct _GPollableInputStreamInterface GPollableInputStreamInterface;
...
struct GPollableInputStreamInterface {
  ...
  /* Virtual Table */
  gboolean     function(GPollableInputStream  *stream) can_poll;

  gboolean     function(GPollableInputStream  *stream) is_readable;
  GSource *    function(GPollableInputStream  *stream,
				    GCancellable          *cancellable) create_source;
  gssize       function(GPollableInputStream  *stream,
				    void                  *buffer,
				    gsize                  count,
				    GError               **error) read_nonblocking;
};

GType    g_pollable_input_stream_get_type         () pure;
