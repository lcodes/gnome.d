...
//struct _GDBusObjectManagerClientClass   GDBusObjectManagerClientClass;
struct _GDBusObjectManagerClientPrivate;
alias _GDBusObjectManagerClientPrivate* GDBusObjectManagerClientPrivate;
...
struct GDBusObjectManagerClientClass {
  ...
  /* signals */
  void    function(GDBusObjectManagerClient *manager,
                                                 GDBusObjectProxy         *object_proxy,
                                                 GDBusProxy               *interface_proxy,
                                                 const(gchar)*              sender_name,
                                                 const(gchar)*              signal_name,
                                                 GVariant                 *parameters) interface_proxy_signal;

  void    function(GDBusObjectManagerClient   *manager,
                                                 GDBusObjectProxy           *object_proxy,
                                                 GDBusProxy                 *interface_proxy,
                                                 GVariant                   *changed_properties,
                                                 const(gchar*)*invalidated_properties) interface_proxy_properties_changed;

  /*< private >*/
  gpointer padding[8];
};

GType                         g_dbus_object_manager_client_get_type           () pure;
