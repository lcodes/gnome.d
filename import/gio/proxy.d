...
struct GProxyInterface {
  ...
  GIOStream * function(GProxy               *proxy,
				     GIOStream            *connection,
				     GProxyAddress        *proxy_address,
				     GCancellable         *cancellable,
				     GError              **error) connect;

  void        function(GProxy               *proxy,
				     GIOStream            *connection,
				     GProxyAddress	  *proxy_address,
				     GCancellable         *cancellable,
  ...
  GIOStream * function(GProxy               *proxy,
				     GAsyncResult         *result,
				     GError              **error) connect_finish;

  gboolean    function(GProxy             *proxy) supports_hostname;
};

GType      g_proxy_get_type                 () pure;
