...
//struct _GTlsInteractionClass   GTlsInteractionClass;
struct _GTlsInteractionPrivate;
alias _GTlsInteractionPrivate* GTlsInteractionPrivate;
...
struct GTlsInteractionClass {
  ...
  /*< public >*/
  GTlsInteractionResult  function(GTlsInteraction    *interaction,
                                                  GTlsPassword       *password,
                                                  GCancellable       *cancellable,
                                                  GError            **error) ask_password;

  void                   function(GTlsInteraction    *interaction,
                                                  GTlsPassword       *password,
                                                  GCancellable       *cancellable,
  ...
  GTlsInteractionResult  function(GTlsInteraction    *interaction,
                                                  GAsyncResult       *result,
                                                  GError            **error) ask_password_finish;
...
GType                  g_tls_interaction_get_type            () pure;
