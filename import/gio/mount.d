...
//struct _GMountIface    GMountIface;
...
struct GMountIface {
  ...
  GFile     * function(GMount              *mount) get_root;
  char      * function(GMount              *mount) get_name;
  GIcon     * function(GMount              *mount) get_icon;
  char      * function(GMount              *mount) get_uuid;
  GVolume   * function(GMount              *mount) get_volume;
  GDrive    * function(GMount              *mount) get_drive;
  gboolean    function(GMount              *mount) can_unmount;
  gboolean    function(GMount              *mount) can_eject;

  void        function(GMount              *mount,
                                             GMountUnmountFlags   flags,
                                             GCancellable        *cancellable,
                                             GAsyncReadyCallback  callback,
                                             gpointer             user_data) unmount;
  gboolean    function(GMount              *mount,
                                             GAsyncResult        *result,
                                             GError             **error) unmount_finish;
  ...
  gchar    ** function(GMount              *mount,
                                             GAsyncResult        *result,
                                             GError             **error) guess_content_type_finish;
  gchar    ** function(GMount              *mount,
                                             gboolean             force_rescan,
                                             GCancellable        *cancellable,
                                             GError             **error) guess_content_type_sync;

  /* Signal, not VFunc */
  void        function(GMount              *mount) pre_unmount;
  ...
  gboolean    function(GMount          *mount,
                                             GAsyncResult        *result,
                                             GError             **error) unmount_with_operation_finish;
  ...
  GFile     * function(GMount              *mount) get_default_location;

  const(gchar)*  function(GMount              *mount) get_sort_key;
};

GType       g_mount_get_type                  () pure;
