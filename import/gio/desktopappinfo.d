...
alias _GDesktopAppInfo* GDesktopAppInfo;
//struct _GDesktopAppInfoClass   GDesktopAppInfoClass;
...
GType            g_desktop_app_info_get_type          () pure;
...
alias _GDesktopAppInfoLookup* GDesktopAppInfoLookup;
//struct _GDesktopAppInfoLookupIface GDesktopAppInfoLookupIface;

struct GDesktopAppInfoLookupIface {
  GTypeInterface g_iface;

  GAppInfo * function(GDesktopAppInfoLookup *lookup,
                                             const(char)*            uri_scheme) get_default_for_uri_scheme;
};

/+ GLIB_DEPRECATED +/
GType     g_desktop_app_info_lookup_get_type                   () pure;
 ...
 */
alias void function(GDesktopAppInfo  *appinfo,
					   GPid              pid,
					   gpointer          user_data) GDesktopAppLaunchCallback;
