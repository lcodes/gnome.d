...
//struct _GTlsConnectionClass   GTlsConnectionClass;
struct _GTlsConnectionPrivate;
alias _GTlsConnectionPrivate* GTlsConnectionPrivate;
...
struct GTlsConnectionClass {
  ...
  /* signals */
  gboolean          function(GTlsConnection       *connection,
					    GTlsCertificate      *peer_cert,
					    GTlsCertificateFlags  errors) accept_certificate;

  /* methods */
  gboolean function(GTlsConnection       *conn,
				  GCancellable         *cancellable,
				  GError              **error) handshake;

  void     function(GTlsConnection       *conn,
				  int                   io_priority,
				  GCancellable         *cancellable,
...
GType                 g_tls_connection_get_type                    () pure;
