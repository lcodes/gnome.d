...
module gio.delayedsettingsbackend;
...
public import gio.settingsbackend;
...
alias _GDelayedSettingsBackendPrivate* GDelayedSettingsBackendPrivate;
//struct _GDelayedSettingsBackendClass                GDelayedSettingsBackendClass;
//struct _GDelayedSettingsBackend                     GDelayedSettingsBackend;

struct GDelayedSettingsBackendClass {
  GSettingsBackendClass parent_class;
};

struct GDelayedSettingsBackend {
  GSettingsBackend parent_instance;
  GDelayedSettingsBackendPrivate *priv;
};

/+ G_GNUC_INTERNAL +/
GType                           g_delayed_settings_backend_get_type     ();
/+ G_GNUC_INTERNAL +/
