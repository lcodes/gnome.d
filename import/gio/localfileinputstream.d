...
module gio.localfileinputstream;
...
//struct _GLocalFileInputStream         GLocalFileInputStream;
//struct _GLocalFileInputStreamClass    GLocalFileInputStreamClass;
struct _GLocalFileInputStreamPrivate;
alias _GLocalFileInputStreamPrivate* GLocalFileInputStreamPrivate;

struct GLocalFileInputStream {
...
struct GLocalFileInputStreamClass {
  GFileInputStreamClass parent_class;
};

GType              _g_local_file_input_stream_get_type () pure;

GFileInputStream *_g_local_file_input_stream_new          (int                    fd);
void              _g_local_file_input_stream_set_do_close (GLocalFileInputStream *in_,
							   gboolean               do_close);
