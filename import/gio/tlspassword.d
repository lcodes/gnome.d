...
//struct _GTlsPasswordClass   GTlsPasswordClass;
struct _GTlsPasswordPrivate;
alias _GTlsPasswordPrivate* GTlsPasswordPrivate;
...
struct GTlsPasswordClass {
  ...
  const(guchar)*     function(GTlsPassword  *password,
                                              gsize         *length) get_value;
  ...
  const(gchar)*      function(GTlsPassword  *password) get_default_warning;
...
GType             g_tls_password_get_type            () pure;
