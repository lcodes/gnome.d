...
alias _GSettingsPrivate* GSettingsPrivate;
//struct _GSettingsClass                              GSettingsClass;

struct GSettingsClass {
  GObjectClass parent_class;

  /* Signals */
  void        function(GSettings    *settings,
                                        const(gchar)*  key) writable_changed;
  void        function(GSettings    *settings,
                                        const(gchar)*  key) changed;
  gboolean    function(GSettings    *settings,
                                        GQuark        key) writable_change_event;
  gboolean    function(GSettings    *settings,
                                        const(GQuark)* keys,
                                        gint          n_keys) change_event;
 ...
 */
alias GVariant *    function(const(GValue)*       value,
                                                                         const(GVariantType)* expected_type,
                                                                         gpointer            user_data) GSettingsBindSetMapping;
 ...
 */
alias gboolean      function(GValue             *value,
                                                                         GVariant           *variant,
 ...
 * Returns: %TRUE if the conversion succeeded, %FALSE in case of an error
 **/
alias gboolean      function(GVariant           *value,
                                                                         gpointer           *result,
                                                                         gpointer            user_data) GSettingsGetMapping;
