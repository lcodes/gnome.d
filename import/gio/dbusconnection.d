...
GType            g_dbus_connection_get_type                   () pure;
...
alias void function(GDBusConnection       *connection,
                                              ...
                                              gpointer               user_data) GDBusInterfaceMethodCallFunc;
 ...
 * Since: 2.26
 */
alias GVariant *function(GDBusConnection       *connection,
                                                    const(gchar)*           sender,
                                                    const(gchar)*           object_path,
                                                    const(gchar)*           interface_name,
                                                    const(gchar)*           property_name,
                                                    GError               **error,
                                                    gpointer               user_data) GDBusInterfaceGetPropertyFunc;
 ...
 * Since: 2.26
 */
alias gboolean  function(GDBusConnection       *connection,
                                                    const(gchar)*           sender,
                                                    const(gchar)*           object_path,
                                                    const(gchar)*           interface_name,
                                                    const(gchar)*           property_name,
                                                    GVariant              *value,
                                                    GError               **error,
                                                    gpointer               user_data) GDBusInterfaceSetPropertyFunc;
 ...
 * Since: 2.26
 */
alias gchar** function(GDBusConnection       *connection,
                                              const(gchar)*           sender,
                                              const(gchar)*           object_path,
                                              gpointer               user_data) GDBusSubtreeEnumerateFunc;
 ...
 * Since: 2.26
 */
alias GDBusInterfaceInfo ** function(GDBusConnection       *connection,
                                                             const(gchar)*           sender,
                                                             const(gchar)*           object_path,
                                                             const(gchar)*           node,
                                                             gpointer               user_data) GDBusSubtreeIntrospectFunc;
 ...
 * Since: 2.26
 */
alias const(GDBusInterfaceVTable)*  function(GDBusConnection             *connection,
                                                                  const(gchar)*                 sender,
                                                                  const(gchar)*                 object_path,
                                                                  const(gchar)*                 interface_name,
                                                                  const(gchar)*                 node,
                                                                  gpointer                    *out_user_data,
                                                                  gpointer                     user_data) GDBusSubtreeDispatchFunc;
...
alias void function(GDBusConnection  *connection,
                                     ...
                                     const(gchar)*      signal_name,
                                     GVariant         *parameters,
                                     gpointer          user_data) GDBusSignalCallback;
 ...
 * Since: 2.26
 */
alias GDBusMessage *function(GDBusConnection *connection,
                                                     GDBusMessage    *message,
                                                     gboolean         incoming,
                                                     gpointer         user_data) GDBusMessageFilterFunction;
