 ...
 * #GSocketAddress<!-- -->es.
 */
//struct _GSocketAddressEnumeratorClass GSocketAddressEnumeratorClass;
...
struct GSocketAddressEnumeratorClass {
  ...
  GSocketAddress * function(GSocketAddressEnumerator  *enumerator,
				    GCancellable              *cancellable,
				    GError                   **error) next;

  void             function(GSocketAddressEnumerator  *enumerator,
				    GCancellable              *cancellable,
				    GAsyncReadyCallback        callback,
				    gpointer                   user_data) next_async;
  GSocketAddress * function(GSocketAddressEnumerator  *enumerator,
				    GAsyncResult              *result,
				    GError                   **error) next_finish;
};

GType           g_socket_address_enumerator_get_type        () pure;
