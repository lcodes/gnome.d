...
//struct _GDBusObjectManagerIface GDBusObjectManagerIface;
...
struct GDBusObjectManagerIface {
  ...
  /* Virtual Functions */
  const(gchar)*     function(GDBusObjectManager    *manager) get_object_path;
  GList           *function(GDBusObjectManager    *manager) get_objects;
  GDBusObject     *function(GDBusObjectManager    *manager,
                                       const(gchar)*           object_path) get_object;
  GDBusInterface  *function(GDBusObjectManager    *manager,
                                       const(gchar)*           object_path,
                                       const(gchar)*           interface_name) get_interface;

  /* Signals */
  void    function(GDBusObjectManager   *manager,
                                           GDBusObject          *object) object_added;
  void    function(GDBusObjectManager   *manager,
                                           GDBusObject          *object) object_removed;
...
GType            g_dbus_object_manager_get_type        () pure;
