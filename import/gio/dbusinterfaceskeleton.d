...
//struct _GDBusInterfaceSkeletonClass   GDBusInterfaceSkeletonClass;
struct _GDBusInterfaceSkeletonPrivate;
alias _GDBusInterfaceSkeletonPrivate* GDBusInterfaceSkeletonPrivate;
...
struct GDBusInterfaceSkeletonClass {
  ...
  /* Virtual Functions */
  GDBusInterfaceInfo   *function(GDBusInterfaceSkeleton  *interface_) get_info;
  GDBusInterfaceVTable *function(GDBusInterfaceSkeleton  *interface_) get_vtable;
  GVariant             *function(GDBusInterfaceSkeleton  *interface_) get_properties;
  void                  function(GDBusInterfaceSkeleton  *interface_) flush;
  ...
  /* Signals */
  gboolean function(GDBusInterfaceSkeleton  *interface_,
                                  GDBusMethodInvocation   *invocation) g_authorize_method;

  /*< private >*/
  gpointer signal_padding[8];
};

GType                        g_dbus_interface_skeleton_get_type        () pure;
