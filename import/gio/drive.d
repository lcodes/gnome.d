 ...
 */
//struct _GDriveIface    GDriveIface;
...
struct GDriveIface {
  ...
  void     function(GDrive              *drive) eject_button;

  /* Virtual Table */
  char *   function(GDrive              *drive) get_name;
  GIcon *  function(GDrive              *drive) get_icon;
  gboolean function(GDrive              *drive) has_volumes;
  GList *  function(GDrive              *drive) get_volumes;
  gboolean function(GDrive              *drive) is_media_removable;
  gboolean function(GDrive              *drive) has_media;
  gboolean function(GDrive              *drive) is_media_check_automatic;
  gboolean function(GDrive              *drive) can_eject;
  gboolean function(GDrive              *drive) can_poll_for_media;
  void     function(GDrive              *drive,
                                         GMountUnmountFlags   flags,
                                         GCancellable        *cancellable,
                                         GAsyncReadyCallback  callback,
                                         gpointer             user_data) eject;
  gboolean function(GDrive              *drive,
                                         GAsyncResult        *result,
                                         GError             **error) eject_finish;
  void     function(GDrive              *drive,
                                         GCancellable        *cancellable,
                                         GAsyncReadyCallback  callback,
  ...
  gboolean function(GDrive              *drive,
                                         GAsyncResult        *result,
                                         GError             **error) poll_for_media_finish;

  char *   function(GDrive              *drive,
                                         const(char)*          kind) get_identifier;
  char **  function(GDrive              *drive) enumerate_identifiers;

  GDriveStartStopType function(GDrive        *drive) get_start_stop_type;

  gboolean function(GDrive              *drive) can_start;
  gboolean function(GDrive              *drive) can_start_degraded;
  void     function(GDrive              *drive,
  ...
  gboolean function(GDrive              *drive,
                                         GAsyncResult        *result,
                                         GError             **error) start_finish;

  gboolean function(GDrive              *drive) can_stop;
  void     function(GDrive              *drive,
                                         GMountUnmountFlags   flags,
                                         GMountOperation     *mount_operation,
                                         GCancellable        *cancellable,
  ...
  gboolean function(GDrive              *drive,
                                         GAsyncResult        *result,
                                         GError             **error) stop_finish;
  /* signal, not VFunc */
  void     function(GDrive              *drive) stop_button;
  ...
  gboolean    function(GDrive            *drive,
                                             GAsyncResult        *result,
                                             GError             **error) eject_with_operation_finish;

  const(gchar)*  function(GDrive              *drive) get_sort_key;
};

GType    g_drive_get_type                 () pure;
