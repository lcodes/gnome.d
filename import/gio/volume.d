 ...
 **/
//struct _GVolumeIface    GVolumeIface;
...
struct GVolumeIface {
  ...
  char      * function(GVolume             *volume) get_name;
  GIcon     * function(GVolume             *volume) get_icon;
  char      * function(GVolume             *volume) get_uuid;
  GDrive    * function(GVolume             *volume) get_drive;
  GMount    * function(GVolume             *volume) get_mount;
  gboolean    function(GVolume             *volume) can_mount;
  gboolean    function(GVolume             *volume) can_eject;
  void        function(GVolume             *volume,
                                         GMountMountFlags     flags,
                                         GMountOperation     *mount_operation,
                                         GCancellable        *cancellable,
                                         GAsyncReadyCallback  callback,
                                         gpointer             user_data) mount_fn;
  gboolean    function(GVolume             *volume,
                                         GAsyncResult        *result,
                                         GError             **error) mount_finish;
  void        function(GVolume             *volume,
  ...
  char      * function(GVolume             *volume,
                                         const(char)*          kind) get_identifier;
  char     ** function(GVolume             *volume) enumerate_identifiers;

  gboolean    function(GVolume             *volume) should_automount;

  GFile     * function(GVolume             *volume) get_activation_root;
  ...
  const(gchar)*  function(GVolume             *volume) get_sort_key;
};

GType    g_volume_get_type              () pure;
