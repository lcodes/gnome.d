...
struct GIconIface {
  ...
  guint       function(GIcon   *icon) hash;
  gboolean    function(GIcon   *icon1,
                               GIcon   *icon2) equal;
  gboolean    function(GIcon   *icon,
			       GPtrArray *tokens,
                               gint    *out_version) to_tokens;
  GIcon *     function(gchar  **tokens,
                               gint     num_tokens,
                               gint     version_,
                               GError **error) from_tokens;
};

GType    g_icon_get_type  () pure;
