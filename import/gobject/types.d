...
GType   g_date_get_type            () pure;
GType   g_strv_get_type            () pure;
GType   g_gstring_get_type         () pure;
GType   g_hash_table_get_type      () pure;
GType   g_array_get_type           () pure;
GType   g_byte_array_get_type      () pure;
GType   g_ptr_array_get_type       () pure;
GType   g_bytes_get_type           () pure;
GType   g_variant_type_get_gtype   () pure;
GType   g_regex_get_type           () pure;
/+ GLIB_AVAILABLE_IN_2_30 +/
GType   g_match_info_get_type      () pure;
GType   g_error_get_type           () pure;
GType   g_date_time_get_type       () pure;
GType   g_io_channel_get_type      () pure;
GType   g_io_condition_get_type    () pure;
GType   g_variant_builder_get_type () pure;
GType   g_key_file_get_type        () pure;
/+ GLIB_AVAILABLE_IN_2_30 +/
GType   g_main_loop_get_type       () pure;
/+ GLIB_AVAILABLE_IN_2_30 +/
GType   g_main_context_get_type    () pure;
/+ GLIB_AVAILABLE_IN_2_30 +/
GType   g_source_get_type          () pure;

/+ GLIB_DEPRECATED_FOR('G_TYPE_VARIANT') +/
GType   g_variant_get_gtype        () pure;
