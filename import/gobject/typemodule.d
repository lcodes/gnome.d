...
//struct _GTypeModule      GTypeModule;
//struct _GTypeModuleClass GTypeModuleClass;
...
struct GTypeModuleClass {
  ...
  /*< public >*/
  gboolean function(GTypeModule *module_) load;
...
GType    g_type_module_get_type       () pure;
gboolean g_type_module_use            (GTypeModule          *module_);
void     g_type_module_unuse          (GTypeModule          *module_);
void     g_type_module_set_name       (GTypeModule          *module_,
                                       const(gchar)*          name);
GType    g_type_module_register_type  (GTypeModule          *module_,
                                       GType                 parent_type,
                                       const(gchar)*          type_name,
                                       const(GTypeInfo)*      type_info,
                                       GTypeFlags            flags);
void     g_type_module_add_interface  (GTypeModule          *module_,
                                       GType                 instance_type,
                                       GType                 interface_type,
                                       const(GInterfaceInfo)* interface_info);
GType    g_type_module_register_enum  (GTypeModule          *module_,
                                       const(gchar)*          name,
                                       const(GEnumValue*)_static_values);
GType    g_type_module_register_flags (GTypeModule          *module_,
                                       const(gchar)*          name,
                                       const(GFlagsValue*)_static_values);
