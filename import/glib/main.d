 ...
 */
//struct _GSourceCallbackFuncs    GSourceCallbackFuncs;
 ...
 * check function_, it tests the results of the poll() call to see if the
 * required condition has been met, and returns %TRUE if so.
 */
//struct _GSourceFuncs            GSourceFuncs;
...
/**
 * GSourceFunc:
 * @user_data: data passed to the function_, set when the source was
 ...
 */
alias gboolean function(gpointer user_data) GSourceFunc;
 ...
 */
alias void     function(GPid     pid,
                                       gint     status,
                                       gpointer user_data) GChildWatchFunc;
struct GSource {
  /*< private >*/
...
guint    g_child_watch_add_full     (gint            priority,
                                     GPid            pid,
                                     GChildWatchFunc function_,
                                     gpointer        data,
                                     GDestroyNotify  notify);
guint    g_child_watch_add          (GPid            pid,
                                     GChildWatchFunc function_,
                                     gpointer        data);
guint    g_idle_add                 (GSourceFunc     function_,
                                     gpointer        data);
