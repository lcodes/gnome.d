 ...
 */
enum GUnicodeScript {                         /* ISO 15924 code */
 ...
 */
gboolean g_unichar_isalnum   (gunichar c) pure;
gboolean g_unichar_isalpha   (gunichar c) pure;
gboolean g_unichar_iscntrl   (gunichar c) pure;
gboolean g_unichar_isdigit   (gunichar c) pure;
gboolean g_unichar_isgraph   (gunichar c) pure;
gboolean g_unichar_islower   (gunichar c) pure;
gboolean g_unichar_isprint   (gunichar c) pure;
gboolean g_unichar_ispunct   (gunichar c) pure;
gboolean g_unichar_isspace   (gunichar c) pure;
gboolean g_unichar_isupper   (gunichar c) pure;
gboolean g_unichar_isxdigit  (gunichar c) pure;
gboolean g_unichar_istitle   (gunichar c) pure;
gboolean g_unichar_isdefined (gunichar c) pure;
gboolean g_unichar_iswide    (gunichar c) pure;
gboolean g_unichar_iswide_cjk(gunichar c) pure;
gboolean g_unichar_iszerowidth(gunichar c) pure;
gboolean g_unichar_ismark    (gunichar c) pure;

/* More <ctype.h> functions.  These convert between the three cases.
 * See the Unicode book to understand title case.  */
gunichar g_unichar_toupper (gunichar c) pure;
gunichar g_unichar_tolower (gunichar c) pure;
gunichar g_unichar_totitle (gunichar c) pure;

/* If C is a digit (according to `g_unichar_isdigit'), then return its
   numeric value.  Otherwise return -1.  */
gint g_unichar_digit_value (gunichar c) pure;

gint g_unichar_xdigit_value (gunichar c) pure;

/* Return the Unicode character type of a given character.  */
GUnicodeType g_unichar_type (gunichar c) pure;

/* Return the line break property for a given character */
GUnicodeBreakType g_unichar_break_type (gunichar c) pure;

/* Returns the combining class for a given character */
gint g_unichar_combining_class (gunichar uc) pure;

gboolean g_unichar_get_mirror_char (gunichar ch,
                                    gunichar *mirrored_ch);

GUnicodeScript g_unichar_get_script (gunichar ch) pure;

/* Validate a Unicode character */
gboolean g_unichar_validate (gunichar ch) pure;
 ...
 */
extern const(gchar*)g_utf8_skip;
...
gunichar g_utf8_get_char           (const(gchar)*  p) pure;
...
glong    g_utf8_pointer_to_offset (const(gchar)* str,
                                   const(gchar)* pos) pure;
gchar*   g_utf8_prev_char         (const(gchar)* p) pure;
gchar*   g_utf8_find_next_char    (const(gchar)* p,
                                   const(gchar)* end) pure;
