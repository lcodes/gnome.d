...
//struct _GOptionEntry   GOptionEntry;
 ...
 */
alias gboolean function(const(gchar)*    option_name,
				    const(gchar)*    value,
				    gpointer        data,
				    GError        **error) GOptionArgFunc;
 ...
 *  occurred, in which case @error should be set with g_set_error()
 */
alias gboolean function(GOptionContext *context,
				      GOptionGroup   *group,
				      gpointer	      data,
				      GError        **error) GOptionParseFunc;
 ...
 */
alias void function(GOptionContext *context,
				  GOptionGroup   *group,
				  gpointer        data,
				  GError        **error) GOptionErrorFunc;
