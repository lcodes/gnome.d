...
struct _GTestCase;
alias _GTestCase* GTestCase;
struct _GTestSuite;
alias _GTestSuite* GTestSuite;
alias void function() GTestFunc;
alias void function(gconstpointer user_data) GTestDataFunc;
alias void function(gpointer      fixture,
                                  gconstpointer user_data) GTestFixtureFunc;
...
//#define g_assert_cmpfloat(n1,cmp,n2)    do { real __n1 = (n1), __n2 = (n2); 
//                                             if (__n1 cmp __n2) ; else 
//                                               g_assertion_message_cmpnum (G_LOG_DOMAIN, __FILE__, __LINE__, G_STRFUNC, 
...
//#define g_assert_not_reached()          do { () 0; } while (0)
//#define g_assert(expr)                  do { () 0; } while (0)
...
//                                         add_vtable 
//                                          (testpath, sizeof (Fixture), tdata, fsetup, ftest, fteardown) add_vtable; 
//					} G_STMT_END
...
double  g_test_timer_elapsed            (); /* elapsed seconds */
double  g_test_timer_last               (); /* repeat last elapsed() result */
...
extern const(GTestConfig*)g_test_config_vars;
 ...
 * Since: 2.22
 */
alias gboolean        function(const(gchar)*    log_domain,
                                                 GLogLevelFlags  log_level,
                                                 const(gchar)*    message,
                                                 gpointer        user_data) GTestLogFatalFunc;
void
